...
#ifndef ASAREN_REMINDER_SWIFT_H
#define ASAREN_REMINDER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="asaren_reminder",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC15asaren_reminder11AppDelegate")
...
SWIFT_CLASS("_TtC15asaren_reminder17MainFlutterWindow")
